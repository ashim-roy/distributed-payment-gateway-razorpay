...
import com.AshimCS.razorpay.common.enums.SettlementStatus;
...
public class Settlement {
    ...
    private UUID merchantId; // every settlement will have a merchant id, so we can identify which merchant this settlement belongs to.
    ...
    private Money refundAmount; // marchant total refunded on that day
    ...
    private Money netAmount; // final amount marchent will receive after deducting fees and gst from gross amount
    ...
    private String bankReference;   // bank reference number for the settlement
